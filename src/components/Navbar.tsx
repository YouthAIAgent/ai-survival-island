          ...
          <div className="hidden md:flex items-center gap-1">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="flex items-center gap-1.5 px-4 py-1.5 rounded text-xs font-bold text-gray-400 hover:text-white hover:bg-white/5 transition-all uppercase tracking-wider"
              >
